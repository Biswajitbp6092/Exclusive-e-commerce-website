...
const Topbar = () => {
  ...
  return (
    <div className="bg-black text-white py-3 text-xs sm:text-sm ">
      <div className="main_container flex items-center justify-between">
        <div className="hidden lg:block w-[100px]" />

        <p className="flex-1 font-poppins font-normal text-[10px] text-left lg:text-center  lg:text-[14px]">
          Summer Sale For All Swim Suits And Free Express Delivery OFF 50%! -
          {"  "}
          <button className="underline hover:text-gray-300 font-semibold pl-1 cursor-pointer">
            ShopNow
          </button>
        </p>
